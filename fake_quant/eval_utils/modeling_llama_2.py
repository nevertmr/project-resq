...
class LlamaDecoderLayer(nn.Module):
    def __init__(self, config: LlamaConfig, layer_idx: int):
        ...
        # self.basis_change_1 = nn.Linear(self.hidden_size, self.hidden_size, bias=False)
        # self.basis_change_2 = nn.Linear(self.hidden_size, self.hidden_size, bias=False)
        self.basis_change_1 = None
        self.basis_change_2 = None
    ...
    def forward(
        ...
        **kwargs,
        ...
        if self.basis_change_1 is not None:
            residual = self.basis_change_1(hidden_states)
        else:
            residual = hidden_states
        ...
        # Fully Connected
        if self.basis_change_2 is not None:
            residual = self.basis_change_2(hidden_states)
        else:
            residual = hidden_states
